                ...
                children: <Widget>[
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => AboutRoute()),  //Goes to about page
                      );
                    },
                  ),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => PrivacyRoute()),  //Goes to privacy page
                      );
                    },
                  ),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LanguageRoute()),  //Goes to language page
                      );
                    },
                  ),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ReminderRoute()),  //Goes to reminder page
                      );
                    },
                  ),
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => FeedbackRoute()),  //Goes to feedback page
                      );
                    },
                  ),
                  ListTile(
                  ...
                  ListTile(
                    ...
                    trailing: Icon(Icons.keyboard_arrow_right),
                    onTap: () {
                      Share.share("Flutter is cool!");   //We can share the text written within the quotes
                    },
                  ),
                ],
              ),
